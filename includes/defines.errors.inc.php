<?php
    ...
    define("ERROR_119","Unable to save module.");define("DEBUGERROR_119","Unable to save module in LessonPlanManager::save().");
    define("ERROR_120","Unable to add module tags.");define("DEBUGERROR_120","Unable to add module tags in LessonPlanManager::addTags().");
    define("ERROR_121","Unable to get module tags.");define("DEBUGERROR_121","Unable to get module tags in LessonPlanManager::getTagsByLessonPlanId().");
    define("ERROR_122","Unable to delete module.");define("DEBUGERROR_122","Unable to delete module in LessonPlanManager::delete().");
    define("ERROR_123","Unable to remove module tags.");define("DEBUGERROR_123","Unable to remove module tags in LessonPlanManager::removeTagAttachments().");
    define("ERROR_124","Unable to load module.");define("DEBUGERROR_124","Unable to load module in LessonPlanManager::loadFromId().");
    ...
    define("ERROR_133","Unable to create new module section.");define("DEBUGERROR_133","Unable to create new module section in LessonPlanManager::addSection().");
    define("ERROR_134","Unable to load module section.");define("DEBUGERROR_134","Unable to load module section in LessonPlanSection::loadFromId().");
    define("ERROR_135","Unable to load module section.");define("DEBUGERROR_135","Unable to load module section in LessonPlanSection::loadFromUri().");
    define("ERROR_136","Unable to save module section.");define("DEBUGERROR_136","Unable to save module section in LessonPlanSection::save().");
    define("ERROR_137","Unable to delete module section.");define("DEBUGERROR_137","Unable to delete module section in LessonPlanSection::delete().");
    define("ERROR_138","Unable to move module section.");define("DEBUGERROR_138","Unable to move module section in LessonPlanSection::setPosition().");
    define("ERROR_139","Unable to save module lesson.");define("DEBUGERROR_139","Unable to save module lesson in LessonPlanLesson::save().");
    define("ERROR_140","Unable to save module lesson.");define("DEBUGERROR_140","Unable to load module lesson from payload in LessonPlanLesson::loadFromPayload().");
    define("ERROR_141","Unable to delete section, since it still contains lessons.");define("DEBUGERROR_141","Unable to delete module section, since it still contains lessons.");
    define("ERROR_142","Unable to load lesson.");define("DEBUGERROR_142","Unable to load lesson in LessonPlanLesson::loadFromUri().");
    define("ERROR_143","Unable to move module lesson.");define("DEBUGERROR_143","Unable to move module lesson in LessonPlanLesson::setPosition().");
    define("ERROR_144","Unable to delete module lesson.");define("DEBUGERROR_144","Unable to delete module lesson in LessonPlanLesson::delete().");
